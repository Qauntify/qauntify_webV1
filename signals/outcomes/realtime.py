...
separate backfill pass (signals/outcomes/tracker.py:backfill_missing_outcome_
...
check_outcome_events / apply_events (signals/outcomes/tracker.py) completely
...
# naming convention (signals/clients/market.py:kraken_pair, e.g. "XBTUSD").
